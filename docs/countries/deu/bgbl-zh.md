...
两个关键时间边界：**本档案是冻结档案，内容止于 2022**；**2023-01-01 起德国改用电子公报，位于 [recht.bund.de](https://www.recht.bund.de)**——2023 年起归姊妹源 `ebgbl`（[ebgbl-zh.md](./ebgbl-zh.md)）。
...
| **2023 年及以后** | 电子公报由姊妹源 `ebgbl` 覆盖（[ebgbl-zh.md](./ebgbl-zh.md)）；本源年份锁定 1949–2022，传 2023+ 报错并指向对方 |
